...
\node {\includegraphics[page=5, trim={4cm 9cm 0 0}]{../Draft/VSP-draft.pdf}};
\spy on (-4.6,2.83) in node [right] at (2,10);
\end{tikzpicture}
...
\begin{columns}[T] % align columns
 \begin{column}{.45\textwidth}
  \makebox[\linewidth][l]{
    \resizebox{\linewidth}{!}{
    \includegraphics[height=\textheight, trim={0 15cm 0 0}]{../Figs/indices_ppp_margins.pdf}
    }
  }
  \end{column}%
  \hspace{2.5ex}
