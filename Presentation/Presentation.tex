...
\begin{column}{.8\textwidth}
  \makebox[\linewidth][l]{
    \resizebox{\linewidth}{!}{
   \begin{tikzpicture}[spy using outlines={chamfered rectangle,blue,magnification=3,width=24cm, height=2.5cm, connect spies}]
\node {\includegraphics[page=5, trim={0 14.5cm 0 0}, clip]{../Draft/VSP-draft.pdf}};
\spy on (-2.8,-1.5) in node [right] at (2,10);
\spy on (-2.8,-4.5) in node [right] at (2,6);
\end{tikzpicture}
